...
var Game = /** @class */ (function () {
  function Game() {
    ...
    this.highest_score = document.getElementById("highest-score")
  ...
  Game.prototype.onAction = async function () {
    switch (this.state) {
      ...
      case this.STATES.ENDED:
        try {
            const response = await fetch("http://localhost:8000/save-score/", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
                body: JSON.stringify({
                    score: Number(this.scoreContainer.innerHTML)
                })
            });
            ...
            this.highest_score.innerHTML = data.score;
